...
namespace BackEnd {
    ...
    void CreateGLFWWindow(const WindowedMode& windowedMode) {
        if (windowedMode == WindowedMode::WINDOWED) {
            ...
            _window = glfwCreateWindow(_windowedWidth, _windowedHeight, "Synergy-Engine", NULL, NULL);
            ...
            _window = glfwCreateWindow(_fullscreenWidth, _fullscreenHeight, "Synergy-Engine", _monitor, NULL);
        }
